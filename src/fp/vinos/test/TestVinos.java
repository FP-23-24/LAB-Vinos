...
public class TestVinos {
	...
	public static void main(String[] args) {
		...
		System.out.println("Casos de prueba para calcularUvasDeRegion");
		System.out.println("===========================================");
		...
		System.out.println("Casos de prueba para calcularVinoMasCaroPorPais");
		System.out.println("==========================================================");		
		testCalcularVinoMasCaroPorPais(vinos1);
		testCalcularVinoMasCaroPorPais(vinos2);
		
		System.out.println("Casos de prueba para calcularNMejoresVinosPorPais");
		System.out.println("==========================================================");		
		testCalcularNMejoresVinosPorPais(vinos1, 3);
		testCalcularNMejoresVinosPorPais(vinos2, 3);
		
		System.out.println("Casos de prueba para calcularRegionConMejoresVinos");
		System.out.println("==========================================================");		
	...
	public static void testCalcularVinoMasCaroPorPais(Vinos vinos) {
	...
	public static void testCalcularNMejoresVinosPorPais(Vinos vinos, Integer n) {
	...
	public static void testCalcularRegionConMejoresVinos(Vinos vinos, Double umbral) {
